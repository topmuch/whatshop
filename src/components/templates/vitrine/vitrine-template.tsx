...
export function VitrineTemplate() {
  ...
  const handleAddDetailedToCart = useCallback(() => {
    ...
    toast.success(`${detailedProduct.name} réservé`)
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center" style={{ backgroundColor: BG_MAIN }}>
        <div className="h-10 w-10 animate-spin rounded-full border-2 border-[#e5e5e5] border-t-[#082231]" />
      </div>
    )
  }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ animation: `vitrine-marquee ${config.speed}s linear infinite` }}
      >
        <span
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-lg transition-colors md:hidden hover:bg-white/10"
              style={{ color: '#ffffff' }}
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="flex h-11 items-center gap-1.5 rounded-full px-3 text-xs font-medium transition-all duration-200 hover:bg-white/10 md:px-4 md:text-sm"
              style={{ color: 'rgba(255,255,255,0.8)' }}
            ...
            <button
              ...
              className="relative flex h-11 w-11 items-center justify-center rounded-full transition-colors hover:bg-white/10"
              style={{ color: '#ffffff' }}
            >
              ...
              <nav className="flex flex-col gap-1 px-4">
                {navLinks.map((link) => (
                  <button
                    ...
                    type="button"
                    onClick={() => { link.action(); onNavClick() }}
                    className="rounded-lg px-4 py-3 text-left text-lg font-medium transition-colors hover:text-white hover:bg-white/10"
                    style={{ color: '#ffffff' }}
                  >
                    {link.label}
                  </button>
          ...
          <div className="mx-auto max-w-lg text-center">
            ...
            >
              <Input
                ...
                required
                className="flex-1 rounded-xl border-[#e5e5e5] bg-white text-gray-900 placeholder:text-[#9ca3af] focus-visible:ring-[#082231] focus-visible:border-[#082231]"
              />
              <Button
                type="submit"
                className="rounded-xl px-6 font-bold text-white transition-colors hover:bg-[#082231]"
...
function VitrineProductCard({
  ...
  const handleAdd = (e: React.MouseEvent) => {
    ...
    toast.success(`${product.name} réservé`)
  }
...
function VitrinePromoDealCard({
  ...
  return (
    <article
      onClick={onClick}
      className="group relative flex cursor-pointer gap-4 overflow-hidden rounded-2xl p-4 transition-all duration-300 hover:border-[#082231]/30"
      style={{
        backgroundColor: BG_CARD,
        border: `1px solid ${BORDER_SUBTLE}`,
      }}
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 md:py-14">
        ...
        <div className="mb-4 flex items-center justify-between gap-3">
          <button
            type="button"
            onClick={onBack}
            className="inline-flex items-center gap-1.5 text-sm font-medium transition-colors hover:text-[#082231]"
    ...
    return (
      <section className="mx-auto max-w-[1440px] px-5 pt-6 md:pt-10 pb-16">
        ...
        <button
          ...
          className="mb-8 flex items-center gap-2 text-sm font-medium transition-colors hover:text-[#082231]"
...
function VitrineFooter({
  ...
  const FOOTER_BG = '#082231'
  const FOOTER_CARD = '#0a2d3f'
  const FOOTER_TEXT = '#e5e7eb'
  const FOOTER_MUTED = '#9ca3af'
  const FOOTER_BORDER = '#0d3a50'
              ...
              <>
                ...
                >
                  <Input
                    ...
                    placeholder="Votre email"
                    required
                    className="h-10 flex-1 rounded-l-lg rounded-r-none border-[#0d3a50] bg-[#0a2d3f] text-sm text-white placeholder:text-[#666] focus:ring-0 focus:border-[#3b6b8a]"
                  />
                  <button
                    type="submit"
