...
const AUTO_MOTO_THEME: ThemeConfig = {
  ...
  hero: {
    defaultTitle: 'PIÈCES AUTO & MOTO',
    defaultSubtitle: 'Pièces détachées et accessoires de qualité',
    defaultTagline: 'QUALITÉ & COMPATIBILITÉ',
    darkMode: true,
  },
  defaultTrustBadges: [
    { emoji: '✅', title: 'Pièces Certifiées', subtitle: 'Originales ou OEM', order: 0 },
    { emoji: '🔍', title: 'Compatibilité Garantie', subtitle: 'Vérification avant envoi', order: 1 },
    { emoji: '🚚', title: 'Livraison Rapide', subtitle: '24-48h', order: 2 },
    { emoji: '🔄', title: 'Retour Facile', subtitle: 'Si incompatibilité', order: 3 },
  ],
  cardMode: 'compat',
...
const QUINCAILLERIE_THEME: ThemeConfig = {
  ...
  colors: {
    ...
    text: '#1F2937',
    background: '#FFFFFF',
    heroOverlay: 'linear-gradient(135deg, rgba(17,24,39,0.9) 0%, rgba(245,158,11,0.7) 100%)',
  },
  hero: {
    defaultTitle: 'QUINCAILLERIE & OUTILLAGE',
    defaultSubtitle: 'Tout pour vos travaux et constructions',
    defaultTagline: 'SOLIDITÉ & PROFESSIONNALISME',
    darkMode: true,
  },
  defaultTrustBadges: [
    { emoji: '🏗️', title: 'Matériaux Robustes', subtitle: 'Qualité professionnelle', order: 0 },
    { emoji: '📦', title: 'Stock Permanent', subtitle: 'Disponible immédiatement', order: 1 },
    { emoji: '🚛', title: 'Livraison Chantier', subtitle: 'Sur devis', order: 2 },
    { emoji: '💰', title: 'Prix Dégressifs', subtitle: 'Selon quantité', order: 3 },
  ],
  cardMode: 'compat',
...
const ARTISANAT_THEME: ThemeConfig = {
  ...
  colors: {
    ...
    text: '#1F2937',
    background: '#FFFFFF',
    heroOverlay: 'linear-gradient(135deg, rgba(17,24,39,0.92) 0%, rgba(30,58,138,0.75) 100%)',
  },
  hero: {
    defaultTitle: 'ARTISANS QUALIFIÉS',
    defaultSubtitle: 'Plomberie, électricité, rénovation et décoration',
    defaultTagline: 'SAVOIR-FAIRE & FIABILITÉ',
    darkMode: true,
    showConsultantPhoto: true,
  },
  defaultTrustBadges: [
    { emoji: '👷', title: 'Artisans Certifiés', subtitle: 'Qualifications vérifiées', order: 0 },
    { emoji: '📋', title: 'Devis Gratuit', subtitle: 'Sous 24h', order: 1 },
    { emoji: '🛡️', title: 'Travaux Assurés', subtitle: 'Responsabilité civile', order: 2 },
    { emoji: '⏱️', title: 'Respect des Délais', subtitle: 'Planning rigoureux', order: 3 },
  ],
  cardMode: 'service',
  ...
  productsSectionTitle: 'Nos Prestations',
  approachSteps: [
    { number: '01', title: 'Prise de contact', description: 'Décrivez votre projet par WhatsApp ou téléphone.', icon: '📞' },
    { number: '02', title: 'Visite & Devis', description: 'Nous évaluons les travaux et vous envoyons un devis détaillé.', icon: '📋' },
    { number: '03', title: 'Réalisation', description: 'Nos artisans interviennent dans les délais convenus.', icon: '🔨' },
  ],
  whyChooseUs: [
    { icon: '👷', title: 'Artisans Qualifiés', description: 'Équipe de professionnels avec 10+ ans d\'expérience.' },
    { icon: '💰', title: 'Prix Transparents', description: 'Devis détaillé sans surprises, prix fixés avant travaux.' },
    { icon: '🛡️', title: 'Travaux Assurés', description: 'Responsabilité civile et garantie décennale.' },
    { icon: '⏱️', title: 'Respect des Délais', description: 'Planning rigoureux et communication régulière.' },
  ],
}
